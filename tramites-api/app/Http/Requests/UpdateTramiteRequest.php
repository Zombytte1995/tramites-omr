...
class UpdateTramiteRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'institucion_id' => ['sometimes', 'required', 'integer', 'exists:instituciones,id'],
            'dias_habiles' => ['sometimes', 'required', 'integer', 'min:1', 'max:365'],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'codigo.unique' => 'Ya existe otro trámite con este código.',
